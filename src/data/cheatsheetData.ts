...
export const cheatsheetData: CheatsheetData = {
  ...
  sections: [
...

    {
      ...
      vulnerabilities: [
        {
          rank: 1, name: "Broken Access Control", severity: "Critical",
          ...
          testMethods: ["Parameter manipulation (change user ID in URL)", "Forced browsing to admin pages", "Missing function level access control", "Insecure direct object references (IDOR)"],
          payloads: [
        ...
        },
        {
          ...
          examples: ["Transmitting data in clear text (HTTP, FTP, SMTP)", "Using old or weak cryptographic algorithms", "Weak or default crypto keys", "Missing encryption for sensitive data at rest", "Improper certificate validation", "Lack of proper key management"],
          testMethods: ["Check for HTTP instead of HTTPS", "Analyze encryption algorithms used", "Test for weak SSL/TLS configurations", "Check for sensitive data in browser storage"],
          tools: ["SSLScan", "testssl.sh", "Nmap SSL scripts"],
        },
        {
          rank: 3, name: "Injection", severity: "Critical",
        ...
        },
        {
          ...
          examples: ["Lack of rate limiting leading to account takeover", "Missing business logic validation", "Trusting client-side controls", "Insufficient logging and monitoring"],
        },
        {
          rank: 5, name: "Security Misconfiguration", severity: "High",
          description: "Insecure default configurations, incomplete setups, open cloud storage",
          examples: ["Missing security hardening", "Unnecessary features enabled", "Default accounts with passwords", "Error handling reveals stack traces", "Latest security features disabled", "Security settings in application servers not set to secure values", "Outdated software versions"],
          testMethods: ["Check for default credentials", "Directory listing enabled", "Verbose error messages", "Unnecessary HTTP methods enabled", "Security headers missing"],
          tools: ["nikto", "dirb", "gobuster"],
        },
        {
          rank: 6, name: "Vulnerable and Outdated Components", severity: "High",
          description: "Using components with known vulnerabilities",
          examples: ["Unsupported or out of date software", "Not scanning for vulnerabilities regularly", "Not securing component configurations", "Developers not testing compatibility of updated libraries"],
          tools: ["OWASP Dependency-Check", "Retire.js", "Snyk", "npm audit", "Bundle-audit (Ruby)"],
        },
        {
          rank: 7, name: "Identification and Authentication Failures", severity: "Critical",
          description: "Broken authentication and session management",
          examples: ["Permits brute force attacks", "Permits default, weak, or well-known passwords", "Uses weak credential recovery (knowledge-based answers)", "Missing or ineffective multi-factor authentication", "Exposes session identifiers in URL", "Doesn't properly invalidate session tokens"],
          testMethods: ["Test password policy", "Session fixation testing", "Session timeout testing", "Brute force protection testing"],
        },
        {
          rank: 8, name: "Software and Data Integrity Failures", severity: "Critical",
          description: "Code and infrastructure that doesn't protect against integrity violations",
          examples: ["Insecure CI/CD pipeline", "Auto-update without integrity verification", "Insecure deserialization", "CDN or content from untrusted sources"],
          covered: "See Insecure Deserialization section above",
        },
        {
          rank: 9, name: "Security Logging and Monitoring Failures", severity: "Medium",
          description: "Insufficient logging and monitoring, coupled with ineffective incident response",
          examples: ["Auditable events not logged", "Warnings and errors generate no/inadequate log messages", "Logs not monitored for suspicious activity", "Logs only stored locally", "Alerting thresholds and response escalation not in place"],
        },
        {
          rank: 10, name: "Server-Side Request Forgery (SSRF)", severity: "High",
